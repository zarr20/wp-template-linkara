...
<div
  class="bg-white min-h-[100vh] flex flex-col">
  <div class="bg-[#14A083]  py-8 px-4 md:px-12 relative">
    <div class="container mx-auto flex justify-between items-center">
      <h1 class="text-4xl font-bold text-white">Our Mission</h1>
  ...
  <div class="container mx-auto px-4 md:px-12 py-8 flex-1  flex justify-center items-center">
    <div class="">
